...
//               key={photo.id}
//             >
//               <Card className="h-100 shadow-lg" style={{ width: "15rem" }}>
...
//                     <Button
//                       variant={
//                         favorites.some((fav: AlbumProps) => fav.id === photo.id)
//                           ? "danger"
//                           : "primary"
//                       }
...
//           <Button variant="outline-secondary">Favorites({favorites.length})</Button>
//         </Link>
//         </div>
//       </Container>
//     </>
